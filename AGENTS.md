...
| 2026-05-xx | `2f054b8` | Prompt 028: added `b_mode='reward_to_choice'` to `BanditTaskNeuroPixelsDataset`; updated `--b_mode` CLI in `bandit_gridsearch.py`; added `scripts/verify_reward_to_choice.py` diagnostic (4/4 criteria pass, JPAS_0023_20230922, 30 Hz gaussian); updated `.ai/bandit.md` (`b_mode` table) and `.ai/scripts.md` |
